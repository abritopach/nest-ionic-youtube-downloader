...
exports.wait = wait;
async function runPlatformHook(config, platformDir, hook) {
    ...
    if (selectedPlatformName) {
        ...
        if (!(await isValidPlatform(platformName))) {
            ...
            errors_1.fatal(`${colors_1.default.strong(platformName)} platform has not been added yet.\n` +
                `See the docs for adding the ${colors_1.default.strong(platformName)} platform: ${colors_1.default.strong(`https://capacitorjs.com/docs/v3/${platformName}#adding-the-${platformName}-platform`)}`);
        }
